...
insert into registryType(id,text,parentID) values(6,'机构管理',-1);
insert into registryType(id,text,parentID) values(7,'钱包管理',-1);
insert into registryType(id,text,parentID) values(8,'交易部门',7);
insert into registryType(id,text,parentID) values(9,'交易渠道',7);
insert into registryTable(id,code,value,typeID,description) values(2,'alarm.exception.email.enabled','true',2,'是否开启异常邮件提醒');
insert into registryTable(id,code,value,typeID,description) values(3,'alarm.email','loceme.student@163.com',2,'接收异常邮件的邮箱地址，多个使用英文逗号隔开');
...
insert into registryTable(id,code,value,typeID,description) values(11,'trade.department.recharge','SK001',8,'收款部门');
insert into registryTable(id,code,value,typeID,description) values(12,'trade.department.consume','SK002',8,'消费部门');
insert into registryTable(id,code,value,typeID,description) values(13,'trade.department.refund','SK003',8,'体现部门');
insert into registryTable(id,code,value,typeID,description) values(14,'trade.department.reward','SK004',8,'体现部门');
insert into registryTable(id,code,value,typeID,description) values(15,'trade.channel.wxpay','WXPAY',9,'微信支付');
insert into registryTable(id,code,value,typeID,description) values(16,'trade.channel.alipay','ALIPAY',9,'支付宝支付');
