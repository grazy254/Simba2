...
public class AliPayEnterpriseBill {
	...
	/**
	 * 状态(SUCCESS：成功（配合"单笔转账到银行账户接口"产品使用时, 同一笔单据多次查询有可能从成功变成退票状态）；
	 * FAIL：失败（具体失败原因请参见error_code以及fail_reason返回值）； INIT：等待处理； DEALING：处理中；
	...
	public String toString() {
		return "AliPayEnterpriseBill{" + "id=" + id + ", outBizNo='" + outBizNo + '\'' + ", payType='" + payType + '\'' + ", account='" + account + '\'' + ", amount='" + amount + '\''
				+ ", payerName='" + payerName + '\'' + ", peyeeName='" + peyeeName + '\'' + ", remark='" + remark + '\'' + ", orderId='" + orderId + '\'' + ", payDate='" + payDate + '\''
				+ ", createTime=" + createTime + ", createUser='" + createUser + '\'' + ", status='" + status + '\'' + ", reason='" + reason + '\'' + ", orderFee='" + orderFee + '\'' + '}';
	}
