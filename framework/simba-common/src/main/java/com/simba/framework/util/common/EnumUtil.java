...
public final class EnumUtil {
	...
	/**
	 * 通过<code>propertyName</code>的 <code>specifiedValue</code><b>(忽视大小写)</b>
	 * 获得枚举(equalsIgnoreCase判断).
	 * 
	 * <h3>说明:</h3> <blockquote>
	 * <ol>
	 * 
	 ...
	 * 
	 * <li>如果你需要值区分大小写,可以调用
	 * {@link #getEnumByPropertyValue(Class, String, Object)}</li>
	 * </ol>
	 * </blockquote>
	 * 
	 * @param <E>
	 ...
	 *            属性值 比如post
	 * @return 如果遍历所有枚举值,找不到枚举值的属性<code>propertyName</code>的值是
	 *         <code>specifiedValue</code>,那么返回null
	 * @throws NoSuchMethodException
	 * @throws InvocationTargetException
	 * @throws IllegalAccessException
	 * @throws NullPointerException
	 *             如果 <code>enumClass</code> 是null,或者 <code>propertyName</code>
	 *             是null
	 * @throws IllegalArgumentException
	 *             如果 <code>propertyName</code> 是blank
	 * @throws BeanOperationException
	 *             如果枚举值没有相关 <code>propertyName</code> 属性,比如
	 *             <code>HttpMethodType</code> 有 <b>"method"</b> 属性,但是没有
	 *             <b>"method2222"</b> 属性
	...
	/**
	 * 通过<code>propertyName</code>的 <code>specifiedValue</code>
	 * 获得枚举(equals判断,<b>区分大小写</b>).
	 * 
	 * <h3>说明:</h3> <blockquote>
	 * <ol>
	 * 
	 ...
	 * </li>
	 * 
	 * <li>如果你需要值不区分大小写,可以调用
	 * {@link #getEnumByPropertyValueIgnoreCase(Class, String, Object)}</li>
	 * </ol>
	 * </blockquote>
	 *
	 * @param <E>
	...
	private static <E extends Enum<?>, T> E getEnumByPropertyValue(Class<E> enumClass, String propertyName, T specifiedValue, boolean ignoreCase)
		...
		for (E e : enumConstants) {
			Object propertyValue = BeanUtils.getProperty(e, propertyName);
