 ...
 * <blockquote>
 * <ol>
 * <li>{@link org.apache.commons.lang3.ObjectUtils#equals(Object, Object)}
 * 支持两个值都是null的情况</li>
 * <li>{@link java.util.Objects#equals(Object, Object)} (since jdk1.7)
 * 也支持两个值都是null的情况</li>
 * </ol>
 * </blockquote>
 *
...
public final class ObjectUtil {
	 ...
	 * <li>如果你只需要判断 null的场景,你可以使用
	 * {@link ObjectUtils#defaultIfNull(Object, Object)}</li>
	 * </ol>
	 * </blockquote>
	 * 
	 * 
	 ...
	 * </pre>
	 * 
	 * 当然对于上面的case,你还可以直接调用
	 * {@link com.feilong.core.util.MapUtil#putMultiValue(java.util.Map, Object, Object)}
	 * 
	 * </blockquote>
	 * 
	 * @param <T>
	 ...
	 * @return 如果 <code>object</code> 是null或者empty,返回
	 *         <code>defaultValue</code>,否则返回 <code>object</code>
	 * @see org.apache.commons.lang3.ObjectUtils#defaultIfNull(Object, Object)
	 * @see org.apache.commons.collections4.ListUtils#defaultIfNull(java.util.List,
	 *      java.util.List)
	 * @since 1.7.2
	 */
	 ...
	 * <blockquote>
	 * <p>
	 * 通常使用<code>instanceof</code>操作符去判断一个对象 <code>object</code> 是否是数组
	 * <code>array</code>.<br>
	 * 在JVM层次,<code>instanceof</code>操作符 translates to a specific "instanceof"
	 * byte code, which is highly optimized in most JVM implementations.<br>
	 * </p>
	 * 
	 * <p>
	 * 而反射的方法(getClass().isArray()) is compiled to two separate "invokevirtual"
	 * instructions.<br>
	 * The more generic optimizations applied by the JVM to these may not be as
	 * fast as the hand-tuned optimizations inherent in the "instanceof"
	 * instruction.<br>
	 * </p>
	 * 
	 * <p>
	 ...
	 * @see <a href=
	 *      "http://stackoverflow.com/questions/219881/java-array-reflection-isarray-vs-instanceof">Java
	 *      array reflection: isArray vs. instanceof</a>
	 * @see <a href=
	 *      "http://stackoverflow.com/questions/2725533/how-to-see-if-an-object-is-an-array-without-using-reflection">How
	 *      to see if an object is an array without using reflection?</a>
	 * @since 1.3.0
	 */
