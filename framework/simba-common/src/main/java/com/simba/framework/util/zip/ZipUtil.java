...
public class ZipUtil {
	 ...
	 * @throws ZipException
	 */
	public static void unzip(File zipFile, String dest, String passwd, String charset) throws ZipException {
		ZipFile zFile = new ZipFile(zipFile); // 首先创建ZipFile指向磁盘上的.zip文件
		zFile.setFileNameCharset(charset); // 设置文件名编码
	 ...
	 * @throws ZipException
	 */
	public static void unzip(String zipFile, String dest, String passwd, String charset) throws ZipException {
		unzip(new File(zipFile), dest, passwd, charset);
	}
	 ...
	 * @throws ZipException
	 */
	public static void unzip(File zipFile, String dest, String charset) throws ZipException {
		unzip(zipFile, dest, null, charset);
	}
