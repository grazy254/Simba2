...
<html>
							...
							<div class="box box-primary">
								...
								<div class="box-body no-padding">
									<div class="mailbox-controls">
										<!-- Check all button -->
										<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="DictionaryType.toAdd();"><i class="fa fa-plus"></i>
                新增</button>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			DictionaryType.initDictionaryTypeList(0, Page.size);
		});
	</script>
