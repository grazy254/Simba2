					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-primary">
								...
								<form role="form" onsubmit="return Project.checkForm();" id="form" action="${base}/project/add">
									<div class="box-body">
										<div class="form-group">
											<label for="code">项目编号</label>
											<input type="text" class="form-control" id="code" name="code" placeholder="请输入项目编号">
										</div>
										<div class="form-group">
