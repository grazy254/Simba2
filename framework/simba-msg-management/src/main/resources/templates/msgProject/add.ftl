					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-primary">
								...
								<form role="form" onsubmit="return Project.checkForm();" id="form" action="${base}/msgProject/add">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="projectKey" name="projectKey" placeholder="请输入ProjectKey">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="threshold" name="threshold" placeholder="请输入报警阈值">
										</div>
										<div class="form-group">
											<label for="limitNum">短信上限</label>
											<input type="text" class="form-control" id="limitNum" name="limitNum" placeholder="请输入短信上限">
										</div>
										<div class="form-group">
