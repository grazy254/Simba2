...
<#include "../iCheck.ftl"/>
    ...
    <link rel="stylesheet" type="text/css" href="${base}/css/project/style.css"/>
                        ...
                        <div class="box-body no-padding">
                            <div class="mailbox-controls">
                                ...
                                <button type="button" class="btn btn-default btn-sm checkbox-toggle"
                                        onclick="Project.toAdd();"><i class="fa fa-plus"></i>
                                    新增
                                </button>
                                <button type="button" class="btn btn-default btn-sm" onclick="Project.batchDelete();"><i
