...
/***********************************************************************
 * Module:  DevProject.java
 * Author:  caozhejun
 * Purpose: Defines the Class DevProject
 ***********************************************************************/
...
public class DevProject {
	 ...
	 * 
	 */
	@DescAnnotation(desc = "版本管理类型(svn/git)")
	 ...
	 * 
	 */
	@DescAnnotation(desc = "服务启动参数")
	private String startParams;

	/**
	 * 通知邮件地址列表
	 */
	@DescAnnotation(desc = "通知邮件地址列表")
