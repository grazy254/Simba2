							...
							<div class="box box-primary">
								...
								<div class="box-body no-padding">
									<div class="mailbox-controls">
										<!-- Check all button -->
										<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="DevProject.rollbackSome();"><i class="fa fa-send"></i>
                回滚</button>
										<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="DevProject.cancelRollbackSomeServers();"><i class="fa fa-remove"></i>
                取消</button>
