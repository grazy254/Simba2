						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">新增服务器</h3>
								</div>
								<form role="form" onsubmit="return ProjectServer.checkForm();" id="form" action="${base}/projectServer/add">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="port" name="port" placeholder="请输入端口号">
										</div>
									</div>
									<!-- /.box-body -->
