						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">新增消息记录</h3>
								</div>
								<form role="form" onsubmit="return PushMessage.checkForm();" id="form" action="${base}/pushMessage/add">
									<div class="box-body">
										<div class="form-group">
											<label for="toUserId">接收方Id</label>
											<input type="text" class="form-control" id="toUserId" name="toUserId" placeholder="请输入接收方Id">
										</div>
										<div class="form-group">
											<label for="fromUserId">发送方Id</label>
											<input type="text" class="form-control" id="fromUserId" name="fromUserId" placeholder="请输入发送方Id">
										</div>
										<div class="form-group">
											<label for="pushType">推送类型</label>
											<input type="text" class="form-control" id="pushType" name="pushType" placeholder="请输入推送类型">
										</div>
										<div class="form-group">
