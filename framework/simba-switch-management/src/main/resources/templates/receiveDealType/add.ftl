						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">新增处理接收消息类型</h3>
								</div>
								<form role="form" onsubmit="return ReceiveDealType.checkForm();" id="form" action="${base}/receiveDealType/add">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="beanId" name="beanId" placeholder="请输入Bean ID">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="ext" name="ext" placeholder="请输入扩展属性">
										</div>
									</div>
									<!-- /.box-body -->
