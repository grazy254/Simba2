						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">新增接收消息</h3>
								</div>
								<form role="form" onsubmit="return ReceiveMsg.checkForm();" id="form" action="${base}/receiveMsg/add">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="source" name="source" placeholder="请输入源">
										</div>
										<div class="form-group">
											<label for="message">内容</label>
											<input type="text" class="form-control" id="message" name="message" placeholder="请输入内容">
										</div>
										<div class="form-group">
