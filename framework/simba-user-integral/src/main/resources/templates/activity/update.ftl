					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-primary">
								...
								<form role="form" onsubmit="return Activity.checkFormUpdate();" id="form" action="${base}/activity/update">
									...
									<div class="box-body">
										...
										<div class="form-group">
											...
											<input type="text" class="datetimepicker" id="start" name="start" value="${activity.startTime}" placeholder="请输入开始时间">
										</div>
										<div class="form-group">
											<label for="end">结束时间</label>
											<input type="text" class="datetimepicker" id="end" name="end" value="${activity.endTime}" placeholder="请输入结束时间">
										</div>
									</div>
									<!-- /.box-body -->
