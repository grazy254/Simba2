						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">新增用户积分变更日志</h3>
								</div>
								<form role="form" onsubmit="return PointDetail.checkForm();" id="form" action="${base}/pointDetail/add">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="expireTime" name="expireTime" placeholder="请输入expireTime">
										</div>
									</div>
									<!-- /.box-body -->
