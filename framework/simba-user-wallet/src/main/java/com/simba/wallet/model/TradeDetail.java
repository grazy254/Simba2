...
/***********************************************************************
 * Module: TradeDetail.java Author: zhangfenghua Purpose: Defines the Class TradeDetail
 ***********************************************************************/
...
public class TradeDetail {
    ...
    public String toString() {
        return "TradeDetail{" + "id=" + id + ", tradeNO='" + tradeNO + '\'' + ", tradeType='"
                + tradeType + '\'' + ", tradeStatus='" + tradeStatus + '\'' + ", orderNO='"
                + orderNO + '\'' + ", orderName='" + orderName + '\'' + ", tradePartyID="
                + tradePartyID + ", tradeCounterpartyID=" + tradeCounterpartyID
                + ", tradeChannelID=" + tradeChannelID + ", tradeCreateTime=" + tradeCreateTime
                + ", tradePaymentTime=" + tradePaymentTime + ", createTime=" + createTime
