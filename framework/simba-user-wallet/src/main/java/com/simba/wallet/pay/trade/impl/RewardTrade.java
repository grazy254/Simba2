...
public class RewardTrade extends BaseInnerTrade {
	...
	public JsonResult trade(String userID, String ip, String location, String orderNO, String orderName, String orderDesc, String orderAddress, long originalAmount, long paymentAmount) {
		return trade(userID, ip, location, orderNO, orderName, orderDesc, orderAddress, paymentAmount, paymentAmount, new Date(), RegistryUtil.get("trade.department.reward"), TradeType.REWARD);
	}
	...
	public void updateBalance(TradeAccount smartUserTradeAccount, TradeAccount departmentTradeAccount, long paymentAmount) {
		...
		smartUserTradeAccount.setVirtualBalance(smartUserTradeAccount.getVirtualBalance() + paymentAmount);
		departmentTradeAccount.setAccountBalance(departmentTradeAccount.getAccountBalance() + paymentAmount);
		departmentTradeAccount.setVirtualBalance(departmentTradeAccount.getVirtualBalance() + paymentAmount);
	}
