...
public class TradeChannelServiceImpl implements TradeChannelService {
    ...
    public void delete(String type) {
        tradeAccountService.closeAccount(type, TradeUserType.CHANNEL);
    ...
    @Override
    @Transactional(readOnly = true)
    public List<TradeChannel> listByAnd(String field1, Object value1, String field2,
            Object value2) {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<TradeChannel> pageByAnd(String field1, Object value1, String field2, Object value2,
            Pager page) {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<TradeChannel> pageByOr(String field1, Object value1, String field2, Object value2,
            Pager page) {
