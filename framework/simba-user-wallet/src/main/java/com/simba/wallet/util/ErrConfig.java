...
public class ErrConfig {
	...
	public final static BussException INVALID_TRADEUSER_ACTIVE_TYPE = new BussException("用户激活状态码错误");
	public final static BussException INVALID_TRADE_PAYMENT_TYPE = new BussException("用户可支付状态码错误");
	public final static BussException INVALID_TRADE_RECHARGEMENT_TYPE = new BussException("用户可充值状态码错误");
