								...
								<form role="form" onsubmit="return TradeDetail.checkForm();" id="form" action="${base}/tradeDetail/add">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="useVirtualBalance" name="useVirtualBalance" placeholder="请输入useVirtualBalance">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="partyTradeUserID" name="partyTradeUserID" placeholder="请输入主交易方TradeUserID">
										</div>
										<div class="form-group">
											<label for="counterpartyTradeUserID">对手主交易方TradeUserID</label>
											<input type="text" class="form-control" id="counterpartyTradeUserID" name="counterpartyTradeUserID" placeholder="请输入对手主交易方TradeUserID">
										</div>
										<div class="form-group">
											<label for="channelTradeUserID">渠道方TradeUserID</label>
											<input type="text" class="form-control" id="channelTradeUserID" name="channelTradeUserID" placeholder="请输入渠道方TradeUserID">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="tradePaymentDate" name="tradePaymentDate" placeholder="请输入支付创建时间">
										</div>
										<div class="form-group">
