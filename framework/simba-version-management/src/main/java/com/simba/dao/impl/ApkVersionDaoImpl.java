...
public class ApkVersionDaoImpl implements ApkVersionDao {
	...
	@Override
	@CacheEvict(cacheNames = "apkVersion", key = "#apkVersion.getTypeId()")
	public void add(ApkVersion apkVersion) {
		...
		jdbc.updateForBoolean(sql, apkVersion.getVersion(), apkVersion.getVersionName(), apkVersion.getTypeId(), apkVersion.getFileSize(), apkVersion.getFileUrl(), apkVersion.getDescription(),
				apkVersion.getCreateTime());
	}
	...
	public void update(ApkVersion apkVersion) {
		...
		jdbc.updateForBoolean(sql, apkVersion.getVersion(), apkVersion.getVersionName(), apkVersion.getTypeId(), apkVersion.getFileSize(), apkVersion.getFileUrl(), apkVersion.getDescription(),
				apkVersion.getCreateTime(), apkVersion.getId());
	}

	@Override
	@CacheEvict(cacheNames = "apkVersion", allEntries = true)
	...
	@Override
	@Cacheable(cacheNames = "apkVersion", key = "#typeId")
