						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title"><#if typeName??>
											${typeName}
										<#else>
											总文件管理
										</#if>
								...
								<div class="box-body no-padding">
									<div class="mailbox-controls">
										...
										<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="CommonFile.search();"><i class="fa fa-search"></i>
                查询</button>
										<div class="pull-right">
											<!-- Check all button -->
											<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="CommonFile.toAdd();"><i class="fa fa-plus"></i>
                新增</button>
											<button type="button" class="btn btn-default btn-sm" onclick="CommonFile.batchDelete();"><i class="fa fa-remove"></i>删除</button>
