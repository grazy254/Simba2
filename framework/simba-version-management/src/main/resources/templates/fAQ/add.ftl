						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">新增常见问题管理</h3>
								</div>
								<form role="form" onsubmit="return FAQ.checkForm();" id="form" action="${base}/fAQ/insertFAQ">
									<div class="box-body">
										<div class="form-group">
											<label for="title">问题名称</label>
											<input type="text" class="form-control" id="title" name="title" placeholder="请输入问题名称">
										</div>
										<div class="form-group">
											<label for="text">问题内容</label>
											<input type="text" class="form-control" id="text" name="text" placeholder="请输入问题内容">
										</div>
										<div class="form-group">
