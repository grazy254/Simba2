						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">常见问题管理</h3>
								</div>
								<!-- /.box-header -->
								<div class="box-body no-padding">
									<div class="mailbox-controls">
										<!-- Check all button -->
										<label for="userId">常见问题类型:</label>
										...
										<input type="text" id="text" name="text" placeholder="请输入内容">
										...
										<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="FAQ.search();"><i class="fa fa-search"></i>
                查询</button>
										<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="FAQ.toAdd();"><i class="fa fa-plus"></i>
                新增</button>
										<button type="button" class="btn btn-default btn-sm" onclick="FAQ.batchDelete();"><i class="fa fa-remove"></i>删除</button>
