					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-primary">
								...
								<form role="form" onsubmit="return FileVersion.checkForm();" id="form" action="${base}/fileVersion/add" method="post" enctype="multipart/form-data">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="extProps" name="extProps" placeholder="请输入扩展属性">
										</div>
										<div class="form-group">
