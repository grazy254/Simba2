 ...
 */
@Component
public class PageParameterBeanPostProcessor implements BeanPostProcessor {

	private static final Log logger = LogFactory.getLog(PageParameterBeanPostProcessor.class);
