						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">新增图文内容</h3>
								</div>
								<form role="form" onsubmit="return Article.checkForm();" id="form" action="${base}/article/add" method="post" enctype="multipart/form-data">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="digest" name="digest" placeholder="请输入描述">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<textarea class="form-control" rows="20" placeholder="请输入内容" id="content" name="content"></textarea>
										</div>
										<div class="form-group">
											<div style="color: red;">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="contentSourceUrl" name="contentSourceUrl" placeholder="请输入原文地址">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div id="imageDiv" style="display: none;">
												<img id="selectedImage" src="" style="width: 50px;height: 50px;" />
											</div>
