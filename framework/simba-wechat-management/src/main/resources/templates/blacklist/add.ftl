					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-primary">
								...
								<form role="form" onsubmit="return Blacklist.checkForm();" id="form" action="${base}/blacklist/add">
									<div class="box-body">
										<div class="form-group">
											<label for="fansId">fansId</label>
											<input type="text" class="form-control" id="fansId" name="fansId" placeholder="请输入fansId">
										</div>
										<div class="form-group">
