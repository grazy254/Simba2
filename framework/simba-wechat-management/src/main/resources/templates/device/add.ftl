					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-primary">
								...
								<form role="form" onsubmit="return Device.checkForm();" id="form" action="${base}/device/add">
									<div class="box-body">
										<div class="form-group">
											<label for="wxDeviceId">微信设备ID</label>
											<input type="text" class="form-control" id="wxDeviceId" name="wxDeviceId" placeholder="请输入微信设备ID">
										</div>
										<div class="form-group">
											<label for="qrcode">二维码</label>
											<input type="text" class="form-control" id="qrcode" name="qrcode" placeholder="请输入二维码">
										</div>
										<div class="form-group">
