							...
							<div class="box box-primary">
								...
								<div class="box-body no-padding">
									<div class="mailbox-controls">
										...
										<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="Fans.search();"><i class="fa fa-search"></i>
                查询</button>

										<div class="pull-right">
											<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="Fans.batchTag();"><i class="fa fa-star-o"></i>
                设置标签</button>
                <button type="button" class="btn btn-default btn-sm" onclick="Fans.batchClearTag();"><i class="fa fa-refresh"></i>清空标签</button>
											<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="Fans.blackBatch();"><i class="fa fa-warning"></i>
                拉黑</button>
											<button type="button" class="btn btn-default btn-sm" onclick="Fans.syncFromWx();"><i class="fa fa-refresh"></i>从微信服务器同步粉丝</button>
										</div>
									</div>
									<!-- /.pull-right -->
								</div>
