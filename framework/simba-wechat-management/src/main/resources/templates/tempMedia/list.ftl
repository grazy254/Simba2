						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">临时素材管理<span style="color: red;">(有效期三天，过期自动删除)</span></h3>
								</div>
								<!-- /.box-header -->
								<div class="box-body no-padding">
									<div class="mailbox-controls">
										...
										<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="TempMedia.search();"><i class="fa fa-search"></i>
                查询</button>
										<div class="pull-right">
											<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="TempMedia.toAdd();"><i class="fa fa-plus"></i>
                新增</button>
										</div>
									</div>
									<!-- /.pull-right -->
