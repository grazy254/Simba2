							...
							<div class="box box-primary">
								...
								<div class="box-body no-padding">
									<div class="mailbox-controls">
										...
										<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="UploadNews.search();"><i class="fa fa-search"></i>
                查询</button>
										<div class="pull-right">
											<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="UploadNews.toAdd();"><i class="fa fa-plus"></i>
                新增</button>
										</div>
									</div>
									<!-- /.pull-right -->
