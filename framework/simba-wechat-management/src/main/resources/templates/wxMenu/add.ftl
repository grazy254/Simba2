					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-primary">
								...
								<form role="form" onsubmit="return WxMenu.checkForm();" id="form" action="${base}/wxMenu/add">
									<div class="box-body">
										<div class="form-group">
											<label for="text">菜单名</label>
											<input type="text" class="form-control" id="text" name="text" placeholder="请输入菜单名">
										</div>
										<div class="form-group">
											<label for="orderNo">排序号</label>
											<input type="text" class="form-control" id="orderNo" name="orderNo" placeholder="请输入排序号">
										</div>
										<div class="form-group">
											<label for="menuKey">菜单KEY值</label>
											<input type="text" class="form-control" id="menuKey" name="menuKey" placeholder="请输入菜单KEY值">
										</div>
										<div class="form-group">
											<label for="url">菜单URL地址</label>
											<input type="text" class="form-control" id="url" name="url" placeholder="请输入菜单URL地址">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="mediaId" name="mediaId" placeholder="请输入素材ID">
										</div>
										<div class="form-group">
											<label for="appid">小程序的appid</label>
											<input type="text" class="form-control" id="appid" name="appid" placeholder="请输入小程序的appid">
										</div>
										<div class="form-group">
											<label for="pagepath">小程序的页面路径</label>
											<input type="text" class="form-control" id="pagepath" name="pagepath" placeholder="请输入小程序的页面路径">
										</div>
										<div class="form-group">
