...
public class RefundCallbackInfo {
	...
	/**
	 * REFUND_SOURCE_RECHARGE_FUNDS 可用余额退款/基本账户 REFUND_SOURCE_UNSETTLED_FUNDS
	 * 未结算资金退款
	 * 
	 */
	...
	public String toString() {
		...
		builder.append("RefundCallbackInfo [transaction_id=");
		...
		builder.append(refund_status);
		builder.append(", success_time=");
		builder.append(success_time);
		builder.append(", refund_recv_accout=");
		builder.append(refund_recv_accout);
		builder.append(", refund_account=");
		builder.append(refund_account);
		builder.append(", refund_request_source=");
		builder.append(refund_request_source);
		builder.append("]");
