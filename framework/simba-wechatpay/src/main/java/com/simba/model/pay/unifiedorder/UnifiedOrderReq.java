...
public class UnifiedOrderReq {
	 ...
	 */
	private String spbill_create_ip = StringUtils.EMPTY;

	/**
	 * 订单生成时间，格式为yyyyMMddHHmmss，如2009年12月25日9点10分10秒表示为20091225091010
	 */
	private String time_start = StringUtils.EMPTY;

	/**
	 * 订单失效时间，格式为yyyyMMddHHmmss，如2009年12月27日9点10分10秒表示为20091227091010(
	 * 最短失效时间间隔必须大于5分钟)
	 */
	private String time_expire = StringUtils.EMPTY;

	/**
	 * 商品标记，使用代金券或立减优惠功能时需要的参数
	 */
	private String goods_tag = StringUtils.EMPTY;

	/**
	 * 异步接收微信支付结果通知的回调地址，通知url必须为外网可访问的url，不能携带参数。
	 */
	private String notify_url = StringUtils.EMPTY;
	 ...
	 * MWEB H5支付
	 */
	private String trade_type = StringUtils.EMPTY;

	/**
	 * trade_type=NATIVE时（即扫码支付），此参数必传。此参数为二维码中包含的商品ID，商户自行定义。
	 */
	private String product_id = StringUtils.EMPTY;

	/**
	 * 上传此参数no_credit--可限制用户不能使用信用卡支付
	 */
	private String limit_pay = StringUtils.EMPTY;
	 ...
	 * 
	 */
	private String scene_info = StringUtils.EMPTY;
