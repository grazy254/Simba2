...
<html>
	<head>
		...
		<script type="text/javascript" src="${base}/js/autoId/autoId.js"></script>
	</head>
							...
							<div class="box box-primary">
								...
								<form role="form" onsubmit="return AutoId.checkForm();" id="form" action="${base}/autoId/add">
									...
									<div class="box-footer">
										...
										<button type="button" class="btn" onclick="AutoId.toList();">取消</button>
									</div>
								</form>
