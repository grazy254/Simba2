...
public class QrcodeUtil {
	 ...
	 */
	public static BitMatrix buildBitMatrix(String text, String format, int height, int width) throws WriterException {
		...
		BitMatrix bitMatrix = new MultiFormatWriter().encode(text, BarcodeFormat.QR_CODE, width, height, param);
		return bitMatrix;
	}
	 ...
	 * @throws WriterException
	 */
	public static BitMatrix buildBitMatrix(String text, int height, int width) throws WriterException {
	 ...
	 * @throws WriterException
	 */
	public static void writeToStream(String text, int height, int width, OutputStream stream) throws IOException, WriterException {
	 ...
	 * @throws WriterException
	 */
	public static void writeToFile(String text, int height, int width, File file) throws IOException, WriterException {
