 ...
 * 
 * <h3>关于 Class {@link java.lang.Class#getCanonicalName() getCanonicalName()} VS
 * {@link java.lang.Class#getName() getName()} VS
 ...
 * <td>返回<b>源代码中</b>给出的底层类的简称。<br>
 * 如果底层类是匿名的则返回一个空字符串。<br>
 * 数组的简称即附带 "[]" 的组件类型的简称。特别地，组件类型为匿名的数组的简称是 "[]"。</td>
 * <td>"DatePattern"</td>
 * </tr>
 * 
 * </table>
 * 
 * <p>
 * {@link java.lang.Class#getCanonicalName() getCanonicalName()} 和
 * {@link java.lang.Class#getName() getName()} 其实这两个方法,对于大部分class来说,没有什么不同的 <br>
 * 但是对于array就显示出来了.
 * </p>
 * 
 * <ul>
 * <li>{@link java.lang.Class#getName() getName()}
 * 返回的是<b>[[Ljava.lang.String</b>之类的表现形式,</li>
 * <li>而 {@link java.lang.Class#getCanonicalName() getCanonicalName()}
 * 返回的就是跟我们声明类似的形式.</li>
 * </ul>
 * 
 * </blockquote>
...
public final class ClassUtil {
	 ...
	 * <tr valign="top">
	 * <td>instanceof运算符</td>
	 * <td><b>针对实例</b>,是用来判断一个对象实例是否是一个类或接口的或其子类子接口的实例<br>
	 ...
	 * <tr valign="top" style="background-color:#eeeeff">
	 * <td>isAssignableFrom</td>
	 * <td><b>针对class对象</b>,是用来判断一个类Class1和另一个类Class2是否相同或是另一个类的超类或接口.<br>
	 ...
	 * </blockquote>
	 * 
	 * <h3>和直接调用 {@link Class#forName(String)}的区别:</h3> <blockquote>
	 * <ol>
	 * 
	 * <li>一般情况下 = {@link Class#forName(String)}</li>
	 * 
	 * <li>Returns the class represented by {@code className} using the
	 * {@code classLoader}. <br>
	 * 支持 " {@code java.util.Map.Entry[]}", "{@code java.util.Map$Entry[]}",
	 * "{@code [Ljava.util.Map.Entry;}", and
	 ...
	 * ClassLoaderUtil.class.getClassLoader()}</li>
	 * </ul>
	 * 
	 * </li>
	 * </ol>
	 ...
	 * @return 如果 <code>className</code> 是null,抛出
	 *         {@link NullPointerException}<br>
	 *         如果 <code>className</code> 是blank,抛出
	 ...
	 * @see org.apache.commons.lang3.ClassUtils#getClass(ClassLoader, String,
	 *      boolean)
