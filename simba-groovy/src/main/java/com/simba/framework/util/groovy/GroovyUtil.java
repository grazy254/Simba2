package com.simba.framework.util.groovy;
...
public class GroovyUtil {
	...
	/** 设置groovy自定义类中的属性值 
	 * @Param GroovyObject 自己缓存的groovy对象
	 * @param String propertyName 属性名
	 * @param Object varVal 属性值 
	 * @return
	 * */
	public static void setProperty(GroovyObject go, String propertyName, Object varVal) throws InstantiationException, IllegalAccessException, CompilationFailedException, IOException{
		if ((go == null) || (propertyName == null) || (varVal == null)) {
			return;
		}
		go.setProperty(propertyName, varVal);
	}
	 ...
	 * @return 属性值
	 * */
	public static Object getProperty(GroovyObject go, String propertyName) throws InstantiationException, IllegalAccessException, CompilationFailedException, IOException{
		if ((go == null) || (propertyName == null)) {
			return null;
		}
		return go.getProperty(propertyName);
	}
}
