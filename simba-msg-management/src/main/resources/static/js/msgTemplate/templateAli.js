var Template = {
	...
	"initTemplateList": function(start, pageSize) {
		$.ajax({
			type: "get",
			url: contextPath + "/msgTemplate/getListAli",
			data: {
				"pageStart": start,
				"pageSize": pageSize
			},
	...
	"toUpdate": function(id) {
		window.self.location.href = contextPath + "/msgTemplate/toUpdateAli?id=" + id;
	},
	...
	"toList": function() {
		window.self.location.href = contextPath + "/msgTemplate/listAli";
	},
