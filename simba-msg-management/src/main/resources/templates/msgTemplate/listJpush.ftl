...
<nav class="navbar navbar-default" role="navigation">
    ...
    <div>
        <ul class="nav navbar-nav">
            <li><a href="${base}/msgTemplate/list">全部模板</a></li>
            <li class="active"><a href="${base}/msgTemplate/listJpush">极光模板</a></li>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body no-padding">
                            <div class="mailbox-controls">
                                ...
                                <button type="button" class="btn btn-default btn-sm" onclick="Template.batchDelete();" style="display: none">
