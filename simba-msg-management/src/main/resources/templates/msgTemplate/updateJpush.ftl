                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">修改极光短信模板</h3>
                        </div>
                        <form role="form" onsubmit="return Template.checkForm();" id="form"
                              action="${base}/msgTemplate/update">
                            <input type="hidden" id="id" name="id" value="${template.id}"/>
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="name">模板名称</label>
                                    <input type="text" class="form-control" id="name" name="name"
                                           value="${template.name}" placeholder="请输入模板名称">
                                </div>
                                <div class="form-group">
                                    <label for="content">模板内容</label>
                                    <input type="text" class="form-control" id="content" name="content"
                                           value="${template.content}" placeholder="请输入模板内容">
                                </div>
                                <div class="form-group" style="display: none">
                                    <label for="createTime">创建时间</label>
                                    <input type="text" class="form-control" id="createTime" name="createTime"
                                           value="${template.createTime}" placeholder="请输入创建时间">
                                </div>
                                <div class="form-group" id="div-statusAli">
                                ...
                                <div class="form-group" id="div-aliId">
                                    <label for="aliTemplateId">阿里模板ID</label>
                                    <input type="text" class="form-control" id="aliTemplateId" name="aliTemplateId"
                                           value="${template.aliTemplateId}" placeholder="请输入阿里模板ID">
                                </div>
                                <div class="form-group">
                                    <label for="jpushTemplateId">极光模板ID</label>
                                    <input type="text" class="form-control" id="jpushTemplateId" name="jpushTemplateId"
                                           value="${template.jpushTemplateId}" placeholder="请输入极光模板ID">
                                </div>
                                <div class="form-group">
                                    <label for="selfId">自定ID</label>
                                    <input type="text" class="form-control" id="selfId" name="selfId"
                                           value="${template.selfId}" placeholder="请输入自定ID">
                                </div>
                            </div>
                            <!-- /.box-body -->
