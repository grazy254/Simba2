...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="${base}/js/permission/currentOrgUser.js"></script>
	</head>
								...
								<form role="form" onsubmit="return User.checkForm();" id="form" action="${base}/currentOrgUser/update">
									...
									<div class="box-body">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="account" name="account" placeholder="请输入账号" value="${user.account}" readonly="true">
										</div>
										<div class="form-group">
										...
										<#list descs as ext>
											<div class="form-group">
												...
												<input type="text" class="form-control" id="${ext.key}" name="${ext.key}" value="${ext.value}" placeholder="${ext.name}">
											</div>
										</#list>
									</div>
									<!-- /.box-body -->
									...
									<div class="box-footer">
										...
										<button type="button" class="btn" onclick="CurrentOrgUser.toList();">取消</button>
									</div>
								</form>
