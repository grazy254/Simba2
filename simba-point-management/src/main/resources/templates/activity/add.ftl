								...
								<form role="form" onsubmit="return Activity.checkForm();" id="form" action="${base}/activity/add">
									<div class="box-body">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="activityID" name="activityID" placeholder="请输入活动id">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="ownerID" name="ownerID" placeholder="请输入活动发起人id">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="createTime" name="createTime" placeholder="请输入活动创建时间">
										</div>
										<div class="form-group">
											<label for="updateTime">updateTime</label>
											<input type="text" class="form-control" id="updateTime" name="updateTime" placeholder="请输入updateTime">
										</div>
									</div>
									<!-- /.box-body -->
