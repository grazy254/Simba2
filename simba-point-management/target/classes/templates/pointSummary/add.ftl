					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-primary">
								...
								<form role="form" onsubmit="return PointSummary.checkForm();" id="form" action="${base}/pointSummary/add">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="point" name="point" placeholder="请输入用户积分">
										</div>
										<div class="form-group">
