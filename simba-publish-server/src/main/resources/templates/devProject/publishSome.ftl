							...
							<div class="box box-primary">
								...
								<div class="box-body no-padding">
									<div class="mailbox-controls">
										<!-- Check all button -->
										<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="DevProject.publishSomeServers();"><i class="fa fa-send"></i>
                发布</button>
										<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="DevProject.cancelPublishSomeServers();"><i class="fa fa-remove"></i>
                取消</button>
