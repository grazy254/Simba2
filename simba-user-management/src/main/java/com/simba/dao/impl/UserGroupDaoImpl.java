...
public class UserGroupDaoImpl implements UserGroupDao {
	...
	public void add(UserGroup userGroup) {
		...
		jdbc.updateForBoolean(sql, userGroup.getName(),userGroup.getDescription(),userGroup.getStatus(),userGroup.getType(),userGroup.getCreater(),userGroup.getCreateTime());
	}

	@Override
	public void update(UserGroup userGroup) {
		String sql = "update " + table + " set  name = ? , description = ? , status = ? , type = ? , creater = ? , createTime = ?  where id = ?  ";
		jdbc.updateForBoolean(sql,userGroup.getName(),userGroup.getDescription(),userGroup.getStatus(),userGroup.getType(),userGroup.getCreater(),userGroup.getCreateTime(), userGroup.getId());
	}
