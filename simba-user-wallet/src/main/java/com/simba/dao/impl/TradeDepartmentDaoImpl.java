...
import com.simba.dao.TradeDepartmentDao;
...
public class TradeDepartmentDaoImpl implements TradeDepartmentDao {
	...
	public void add(TradeDepartment tradeDepartment) {
		String sql = "insert into " + table + "( deptNO, deptName, createTime, lastUpdateTime) values(?,?,?,?)";
		jdbc.updateForBoolean(sql, tradeDepartment.getDeptNO(),tradeDepartment.getDeptName(),tradeDepartment.getCreateTime(),tradeDepartment.getLastUpdateTime());
	}
