...
public class TradeChannelDetailDaoImpl implements TradeChannelDetailDao {
    ...
    @Override
    public List<TradeChannelDetail> listByAnd(String field1, Object value1, String field2,
            Object value2) {
        String sql = "select * from " + table + " where " + field1 + " = ? and " + field2 + " = ? ";
    ...
    @Override
    public List<TradeChannelDetail> listByOr(String field1, Object value1, String field2,
            Object value2) {
        String sql = "select * from " + table + " where " + field1 + " = ? or " + field2 + " = ? ";
        return jdbc.queryForList(sql, TradeChannelDetail.class, value1, value2);
    }
    ...
    @Override
    public List<TradeChannelDetail> pageByAnd(String field1, Object value1, String field2,
    ...
    @Override
    public List<TradeChannelDetail> pageByOr(String field1, Object value1, String field2,
            Object value2, Pager page) {
        String sql = "select * from " + table + " where " + field1 + " = ? or " + field2 + " = ? ";
        StatementParameter param = new StatementParameter();
        param.set(value1);
