...
public class TradePartyDetailDaoImpl implements TradePartyDetailDao {
    ...
    public void update(TradePartyDetail tradePartyDetail) {
        String sql = "update " + table
                + " set  tradeUserID = ? , partyName = ? , partyType = ? , tradeAccountID = ? , ip = ? , mobileNumber = ? , device = ? , noticeMail = ? , location = ? , createTime = ?  where id = ?  ";
        jdbc.updateForBoolean(sql, tradePartyDetail.getTradeUserID(),
                tradePartyDetail.getPartyName(), tradePartyDetail.getPartyType(),
                tradePartyDetail.getTradeAccountID(), tradePartyDetail.getIp(),
                tradePartyDetail.getMobileNumber(), tradePartyDetail.getDevice(),
                tradePartyDetail.getNoticeMail(), tradePartyDetail.getLocation(),
    ...
    @Override
    public List<TradePartyDetail> listByAnd(String field1, Object value1, String field2,
            Object value2) {
        String sql = "select * from " + table + " where " + field1 + " = ? and " + field2 + " = ? ";
    ...
    @Override
    public List<TradePartyDetail> listByOr(String field1, Object value1, String field2,
            Object value2) {
        String sql = "select * from " + table + " where " + field1 + " = ? or " + field2 + " = ? ";
        return jdbc.queryForList(sql, TradePartyDetail.class, value1, value2);
    }
    ...
    @Override
    public List<TradePartyDetail> pageByAnd(String field1, Object value1, String field2,
    ...
    @Override
    public List<TradePartyDetail> pageByOr(String field1, Object value1, String field2,
            Object value2, Pager page) {
        String sql = "select * from " + table + " where " + field1 + " = ? or " + field2 + " = ? ";
        StatementParameter param = new StatementParameter();
        param.set(value1);
