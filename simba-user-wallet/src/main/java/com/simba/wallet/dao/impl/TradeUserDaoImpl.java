...
public class TradeUserDaoImpl implements TradeUserDao {
    ...
    public long add(TradeUser tradeUser) {
        ...
        Number id = jdbc.updateForGeneratedKey(sql, tradeUser.getUserID(), tradeUser.getName(),
                tradeUser.getType(), tradeUser.getIsAllowPay(), tradeUser.getIsActive(),
                tradeUser.getPayPassword(), tradeUser.getPayPhone(), tradeUser.getPayEmail(),
                tradeUser.getCreateTime(), tradeUser.getLastUpdateTime());
        return id.longValue();
    }
    ...
    public void update(TradeUser tradeUser) {
        ...
        jdbc.updateForBoolean(sql, tradeUser.getUserID(), tradeUser.getName(), tradeUser.getType(),
                tradeUser.getIsAllowPay(), tradeUser.getPayPassword(), tradeUser.getPayPhone(),
