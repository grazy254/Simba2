...
/***********************************************************************
 * Module: TradePartyDetail.java Author: zhangfenghua Purpose: Defines the Class TradePartyDetail
 ***********************************************************************/
...
public class TradePartyDetail {
    ...
    public String toString() {
        return "TradePartyDetail{" + "id=" + id + ", tradeUserID=" + tradeUserID + ", partyName='"
                + partyName + '\'' + ", partyType='" + partyType + '\'' + ", tradeAccountID='"
                + tradeAccountID + '\'' + ", noticeMail='" + noticeMail + '\'' + ", createTime="
                + createTime + '}';
    }
