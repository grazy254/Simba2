...
public class TradeUser implements Serializable {
	...
	public String toString() {
		return "TradeUser{" + "id=" + id + ", userID='" + userID + '\'' + ", name='" + name + '\'' + ", isAllowPay="
				+ isAllowPay + ", payPassword='" + payPassword + '\'' + ", payPhone='" + payPhone + '\''
				+ ", payEmail='" + payEmail + '\'' + ", createTime=" + createTime + ", lastUpdateTime=" + lastUpdateTime
				+ '}';
	}
