						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">新增收款部门</h3>
								</div>
								<form role="form" onsubmit="return TradeDepartment.checkForm();" id="form" action="${base}/tradeDepartment/add">
									<div class="box-body">
										<div class="form-group">
											<label for="deptNO">部门编号</label>
											<input type="text" class="form-control" id="deptNO" name="deptNO" placeholder="请输入部门编号">
										</div>
										<div class="form-group">
