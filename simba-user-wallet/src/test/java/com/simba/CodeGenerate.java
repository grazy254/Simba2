...
public class CodeGenerate {
	...
	public static void main(String[] args) throws IOException, TemplateException {
		...
		//TradeChannel.class,TradeChannelDetail.class,TradeDepartment.class, 
		// TradeDetail.class, TradePartyDetail.class,TradeAccount.class,
		// TradeUser.class
		Class<?>[] classes = new Class<?>[] { TradeDetail.class };
		// 将创建好的搜索用的Form类放入下面的数据组中
		Class<?>[] searchFormClasses = new Class<?>[] { TradeDetailSearchForm.class };
		...
		CodeGenerateUtil.getInstance().codeGenerate(classes, searchFormClasses, codeType, pageType, projectName,
				webPath);
		System.exit(0);
	}
