							...
							<div class="box box-primary">
								...
								<div class="box-body no-padding">
									<div class="mailbox-controls">
										<!-- Check all button -->
										<label for="userId">反馈意见用户Id:</label>
										...
										<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="OpinionFeedback.search();"><i class="fa fa-search"></i>
                查询</button>
										<button type="button" class="btn btn-default btn-sm checkbox-toggle" onclick="OpinionFeedback.toAdd();"><i class="fa fa-plus"></i>
                新增</button>
										<button type="button" class="btn btn-default btn-sm" onclick="OpinionFeedback.batchDelete();"><i class="fa fa-remove"></i>删除</button>
