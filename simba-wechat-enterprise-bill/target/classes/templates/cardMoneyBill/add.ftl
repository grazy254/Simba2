					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-primary">
								...
								<form role="form" onsubmit="return CardMoneyBill.checkForm();" id="form" action="${base}/cardMoneyBill/add">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="partnerTradeNo" name="partnerTradeNo" placeholder="请输入商户企业付款单号">
										</div>
										<div class="form-group">
											<label for="bankNo">收款方银行卡号</label>
											<input type="text" class="form-control" id="bankNo" name="bankNo" placeholder="请输入收款方银行卡号">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="bankCode" name="bankCode" placeholder="请输入收款方开户行">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="description" name="description" placeholder="请输入付款说明">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="paymentNo" name="paymentNo" placeholder="请输入微信企业付款单号">
										</div>
										<div class="form-group">
											<label for="cmmsAmt">手续费金额</label>
											<input type="text" class="form-control" id="cmmsAmt" name="cmmsAmt" placeholder="请输入手续费金额">
										</div>
										<div class="form-group">
