					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="box box-primary">
								...
								<form role="form" onsubmit="return Tag.checkForm();" id="form" action="${base}/tag/update">
									<input type="hidden" id="id" name="id" value="${tag.id}" />
									<div class="box-body">
										<div class="form-group">
											<label for="name">标签名</label>
											<input type="text" class="form-control" id="name" name="name" value="${tag.name}" placeholder="请输入标签名">
										</div>
									</div>
									<!-- /.box-body -->
									...
									<div class="box-footer">
										...
										<button type="button" class="btn" onclick="Tag.toList();">取消</button>
									</div>
								</form>
