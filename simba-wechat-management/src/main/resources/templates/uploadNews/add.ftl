						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">新增上传图文</h3>
								</div>
								<form role="form" onsubmit="return UploadNews.checkForm();" id="form" action="${base}/uploadNews/add">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<button type="button" class="btn" onclick="UploadNews.selectArticle();"><i class="fa fa-search"></i>选择图文内容</button>
										</div>
									</div>
									<!-- /.box-body -->
