						...
						<div class="col-md-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">新增粉丝</h3>
								</div>
								<form role="form" onsubmit="return Fans.checkForm();" id="form" action="${base}/fans/add">
									<div class="box-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="province" name="province" placeholder="请输入省份">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="headimgurl" name="headimgurl" placeholder="请输入头像">
										</div>
										<div class="form-group">
											<label for="subscribeTime">关注时间</label>
											<input type="text" class="form-control" id="subscribeTime" name="subscribeTime" placeholder="请输入关注时间">
										</div>
									</div>
									<!-- /.box-body -->
