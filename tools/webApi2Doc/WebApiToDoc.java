...
public class WebApiToDoc {
    ...
    public static void main(String[] args) {
        /* 配置要转换的class和转换程序路径 */
        List<Class<?>> classList = ClassUtil.getClasses("com.simba.controller", false, false);
        String execPath = "C:/Users/linshuo.UT/Desktop/webApi2doc/dist/webApi2doc/webApi2doc.exe";
        /* 进行转换 */
        {
            ...
            try {
                String cmd = execPath + " \"" + json.replace("\"", "\\\"") + "\"";
